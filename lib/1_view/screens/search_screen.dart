...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void initState() {
    ...
    super.initState();
    context.read<SearchCubit>().searchFilterJobs("", "", "",searchController:searchController);
  }
  @override
                      ...
                      children: [
                                    ...
                                    onPressed: () {
                                     // BottomSheet(onClosing: () => Navigator.pop(context),builder:(context) =>  const BottomSheetSetFilter(),);
                                      showMaterialModalBottomSheet(
                                        context: context,
                                        builder: (context) => const BottomSheetSetFilter(),
                                      );
                        ...
                        SizedBox(
                          ...
                          child: ListView.builder(
                            ...
                            itemCount: context.read<SearchCubit>().isFiltered==false?SearchModel.data!.length:SearchFilteringModel.data!.length,
                            itemBuilder: (context, index) {
                              return context.read<SearchCubit>().isFiltered==false?
                                MainSearchItem(
                                index: index,
                                ...
                                return Column(
                                  children: [
                                    SearchRow(
                                      ...
                                      title: popular[index],
                                      suffixIcon: AppImages.roundedArrowRight,
